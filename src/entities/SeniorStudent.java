...
public class SeniorStudent extends Student implements Displayable {
    ...
    public SeniorStudent(String personId, String firstName, String lastName, String dateOfBirth, String gender, String phoneNumber, String email, String address, int nationalId, int age, String activeStatus) {
