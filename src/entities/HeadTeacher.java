...
public class HeadTeacher extends Teacher implements Displayable {
    ...
    public HeadTeacher(String personId, String firstName, String lastName, String dateOfBirth, String gender, String phoneNumber, String email, String address, int nationalId, int age, String activeStatus) {
